...
public class SignIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setText("hasiya@gmail.com");
        ...
        jLabel5.setText("By Signinup, I agree to the terms of services and the Privacy Policy");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/signin.png"))); // NOI18N
    ...
    private void jPasswordField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jPasswordField1KeyReleased
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            if (email.isEmpty()) {
                ...
                Notifications.getInstance().setJFrame(this);
                Notifications.getInstance().show(Notifications.Type.WARNING, Notifications.Location.TOP_RIGHT, "Please Enter password");
                ...
                try {
                    ...
                    loggerFile.log(Level.SEVERE, "SignIn1" ,e);
                }
...
String email = jTextField1.getText();
        ...
        if (email.isEmpty()) {
            ...
            try {
                ...
                e.printStackTrace();
                Logger loggerFile = SplashScreen.getLoggerFile();
                loggerFile.log(Level.SEVERE, "SignIn2" ,e);
            }
